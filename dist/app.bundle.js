...
angular.module('angular-test', [__webpack_require__(/*! ./mathservice */ "./src/mathservice.js").name]).controller('homeController', ['$scope', 'postService', function ($scope, postService) {
...
module.exports = angular.module('math', []).service('mathservice', function () {
